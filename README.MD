...
- **Clone your GitHub repo**
  ...
  ```bash
  git clone https://github.com/saibharath2005/Anime_Recommendar_System_LLMOPS.git
  ls
  cd TESTING-9
...
```bash
git config --global user.email "rallabandisaibharath@gmail.com"
git config --global user.name "saibharath2005"
